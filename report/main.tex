...
\begin{figure}[htbp]
  ...
  \caption{Disease progression modeling with Leaspy on the built-in Parkinson's dataset.
    (a)~Average population trajectory of clinical scores over the estimated disease timeline.
    (b)~Personalized trajectory (solid line) and observed visits (dots) for one patient.}
  \label{fig:parkinson}
\end{figure}
\vspace*{-0.2cm}
