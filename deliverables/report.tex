...
\begin{figure}
  \centering
  \includegraphics[width=0.7\textwidth]{figures/riemannian_pov.png}
...
\begin{figure}[htbp] 
  ...
  \begin{tikzpicture}[
    ...
    \node[box, fill=red!8,      below=1.8cm of fit] (per)
          {Individual parameters\\$(\hat{\tau}_i^{(m)},\,\hat{\xi}_i^{(m)}, \dots)$};

    % True individual parameters node
    \node[box, fill=blue!8,    below=1.8cm of sim] (trueip)
          {True individual parameters\\$(\tau_i^{(m)},\,\xi_i^{(m)}, \dots)$};
