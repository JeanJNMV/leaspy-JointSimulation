...
\todo{TODO + mettre plus de lignes dans les figures}
...
$\text{w}_i^{(0)}$ & $0.989 \pm 0.003$ & $0.990 \pm 0.003$ \\
$\text{w}_i^{(1)}$ & $0.990 \pm 0.003$ & $0.991 \pm 0.003$ \\
$\text{w}_i^{(2)}$ & $0.982 \pm 0.011$ & $0.991 \pm 0.003$ \\
