...
% Abstract 
\begin{abstract}
        TODO\todo{ATTENTION INCLURE LES PARTIES CS}
\end{abstract}
\newpage
...
TODO\todo{doit inclure les autres travaux au sein du labo (workshop, review, etc.) qui ne sont pas détaillés dans le rapport}
...
Each synthetic cohort contains $N = TODO$ patients, and the experiment is repeated $M = TODO$ times. Each fresh model is fitted using the MCMC-SAEM algorithm with $N_{\mathrm{iter}} = TODO$ iterations, and the subsequent personalisation step runs for $N_{\mathrm{perso}} = TODO$ iterations. \todo{remplir les valeurs}

\subsection{Results and Interpretation}

\todo{remplacer par les figures finales}
...
\hline
Parameter & $\theta$ (true) & $\bar{\theta}$ (M) & RB (\%) & RRMSE (\%) & RSE \\
\hline
$\beta$ (mean)        &  0.00858  &  0.00005    & $-$99.439 & 252.612 & 418.0295 \\
$\tilde{g}$ (mean)    &  0.49849  &  0.43662  & $-$12.412 &  14.664 &   0.0901 \\
$\tilde{\rho}$        &  0.67007  &  0.34871  & $-$47.960  &  54.429 &   0.4996 \\
$\tilde{v}_0$ (mean)  & $-$4.15871 & $-$4.32777 & $-$4.065 &   9.422 &   0.0825 \\
$\tilde{\nu}$         & $-$1.91844 & $-$2.77983 & $-$44.900  &  52.409 &   0.1884 \\
$\sigma$              &  0.39104  &  0.37596  & $-$3.858  &   3.882 &   0.0046 \\
$t_0$                 & 66.07919  & 66.95525  &    1.326  &   2.932 &   0.0261 \\
$\sigma_{\tau}$       & 10.36347  & 10.24343  & $-$1.158  &  13.119 &   0.1335 \\
$\sigma_{\xi}$        &  1.34546  &  1.68284  &   25.075  &  31.843 &   0.1585 \\
$\zeta$ (mean)        & $-$0.23890 & $-$0.00673 &  97.185  & 102.854 &  12.0835 \\
\hline
\end{tabular}
\end{table}
...
\begin{table}[htbp]
\centering
\caption{Agreement statistics for individual random effects.}
\begin{tabular}{lcc}
\hline
 & ICC(3,1) & Pearson $r$ \\
\hline
$\xi$  & $0.888 \pm 0.044$ & $0.910 \pm 0.031$ \\
$\tau$ & $0.897 \pm 0.083$ & $0.912 \pm 0.063$ \\
\hline
\end{tabular}
\end{table}
...
\begin{table}[htbp]
\centering
\caption{Bland-Altman analysis of individual parameter recovery.}
\begin{tabular}{lrrr}
\hline
 & Bias & LoA lower & LoA upper \\
\hline
$\xi$  & $0.0043$ & $-1.3839$ & $1.3925$ \\
$\tau$ & $0.6034$ & $-7.9239$ & $9.1307$ \\
\hline
\end{tabular}
\end{table}
